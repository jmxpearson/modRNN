...
class Trainer:
    ...
    def plot_training_history(self, save: bool = True):
        ...
        # Plot accuracy
        axes[1, 1].plot(
            epochs, self.history["val_accuracy"], linewidth=2, color="green"
        )
...
def main():
    ...
    # Train model
    trainer.train(n_epochs=100, save_every=10, plot_every=5, scheduler=scheduler)
    ...
    test_loader_eval = DataLoader(test_loader.dataset, batch_size=32, shuffle=False)
